...
void DS4::decode_ps4()
{
  ...
  if (((ps4_ic2[8] & 0x0F) == 5) || ((ps4_ic2[8] & 0x0F) == 6) || ((ps4_ic2[8] & 0x0F) == 7))
    button_left = 1;
  else
    button_left = 0; // W
  if (((ps4_ic2[8] & 0x0F) == 3) || ((ps4_ic2[8] & 0x0F) == 4) || ((ps4_ic2[8] & 0x0F) == 5))
    button_down = 1;
  else
    button_down = 0; // S
  if (((ps4_ic2[8] & 0x0F) == 1) || ((ps4_ic2[8] & 0x0F) == 2) || ((ps4_ic2[8] & 0x0F) == 3))
    button_right = 1;
  else
    button_right = 0; // E
  if (((ps4_ic2[8] & 0x0F) == 0) || ((ps4_ic2[8] & 0x0F) == 1) || ((ps4_ic2[8] & 0x0F) == 7))
    button_up = 1;
  else
    button_up = 0;                                    // N
